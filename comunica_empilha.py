...
def insereCubos(clientID, posCubos):
    ...
    for i in range(3):
        ...
        vrep.simxSetObjectPosition(clientID, cubo, mesa, posCubos[i], vrep.simx_opmode_blocking) #Posiciona os cubos no local identificado
    return 0
...
def pegaCubo(x, y, z, ang):
    angu = cinematicaInversa(x, y, z+0.2, ang)
...
#Cubo 1 = 1.0250, -0.15, 0.55, 0
#Cubo 2 = 0.85, -0.125, 0.55, 0
#Cubo 3 = 1.025, 0.075, 0.55, 0


#Pega o primeiro cubo
pegaCubo(1.0250, -0.15, 0.55, 0)
anguloss = cinematicaInversa(1.0250, -0.15, 0.55, 0)
...
#Pega o segundo cubo
pegaCubo(0.85, -0.125, 0.55, 0)
anguloss = cinematicaInversa(0.85, -0.125, 0.55, 0)
moveRobo(clientID, anguloss)
...
pegaCubo(1.025, 0.075, 0.55, 0)
anguloss = cinematicaInversa(1.025, 0.075, 0.55, 0)
moveRobo(clientID, anguloss)
